    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      {schedules.length === 0 ? (
        <div className="card text-center py-12 text-gray-500">
          ...
          <p className="text-sm mt-1">Check back soon or request an on-demand ride</p>
          <Link href="/passenger/book/on-demand" className="btn-primary inline-block mt-4">
            Request On-Demand Ride
          </Link>
        </div>
      ) : (
