...
const bottomNav = [
  { name: 'Home',     href: '/passenger',          icon: '📊' },
  { name: 'Book',     href: '/passenger/book',     icon: '🚗' },
  { name: 'Trips',    href: '/passenger/trips',    icon: '📍' },
  { name: 'Wallet',   href: '/passenger/wallet',   icon: '💰' },
  { name: 'Profile',  href: '/passenger/profile',  icon: '👤' },
]
    ...
    <>
      ...
      <div className="hidden lg:flex lg:flex-col lg:w-64 lg:bg-white lg:shadow-lg lg:flex-shrink-0">
        <div className="flex items-center h-16 px-6 border-b">
          <span className="text-xl font-bold text-primary-600">Passenger</span>
        </div>
      ...
      <div className="lg:hidden fixed top-0 inset-x-0 z-40 h-14 bg-white border-b shadow-sm flex items-center justify-between px-4">
        <span className="text-lg font-bold text-primary-600">Passenger</span>
